exports.selfAssessmentValidation = [
  body('socialLevel')
    .isIn(['low', 'medium', 'high']).withMessage('Social level must be low, medium, or high'),
  body('primaryGoal')
    .optional()
  ...
  body('communicationConfidence')
    .optional()
    .isInt({ min: 1, max: 10 }).withMessage('Communication confidence must be between 1 and 10'),
